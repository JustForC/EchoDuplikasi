...
func (ac *AchievementCreate) SetNillableName(s *string) *AchievementCreate {
	if s != nil {
		ac.SetName(*s)
	}
	return ac
...
func (ac *AchievementCreate) SetOrganizer(s string) *AchievementCreate {
	ac.mutation.SetOrganizer(s)
	return ac
}

// SetNillableOrganizer sets the "organizer" field if the given value is not nil.
func (ac *AchievementCreate) SetNillableOrganizer(s *string) *AchievementCreate {
	if s != nil {
		ac.SetOrganizer(*s)
	}
	return ac
...
func (ac *AchievementCreate) SetLevel(s string) *AchievementCreate {
	ac.mutation.SetLevel(s)
	return ac
}

// SetNillableLevel sets the "level" field if the given value is not nil.
func (ac *AchievementCreate) SetNillableLevel(s *string) *AchievementCreate {
	if s != nil {
		ac.SetLevel(*s)
	}
	return ac
...
func (ac *AchievementCreate) createSpec() (*Achievement, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.Organizer(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
