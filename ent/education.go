...
type Education struct {
	...
	// Enter holds the value of the "enter" field.
...
func (*Education) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case education.FieldGrade, education.FieldName, education.FieldProvince, education.FieldCity, education.FieldEnter, education.FieldGraduate:
...
func (e *Education) assignValues(columns []string, values []interface{}) error {
	...
	for i := range columns {
		...
		case education.FieldEnter:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field enter", values[i])
			} else if value.Valid {
				e.Enter = value.String
			}
		case education.FieldGraduate:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field graduate", values[i])
			} else if value.Valid {
				e.Graduate = value.String
			}
		}
	}
	return nil
...
func (e *Education) String() string {
	...
	builder.WriteString(e.Province)
	builder.WriteString(", city=")
	builder.WriteString(e.City)
	builder.WriteString(", enter=")
	builder.WriteString(e.Enter)
	builder.WriteString(", graduate=")
	builder.WriteString(e.Graduate)
	builder.WriteByte(')')
