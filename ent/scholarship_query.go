...
// Where adds a new predicate for the ScholarshipQuery builder.
...
func (sq *ScholarshipQuery) Unique(unique bool) *ScholarshipQuery {
	sq.unique = &unique
	return sq
}
...
// First returns the first Scholarship entity from the query.
// Returns a *NotFoundError when no Scholarship was found.
...
// FirstID returns the first Scholarship ID from the query.
// Returns a *NotFoundError when no Scholarship ID was found.
...
func (sq *ScholarshipQuery) FirstIDX(ctx context.Context) int {
...
// Only returns a single Scholarship entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one Scholarship entity is found.
// Returns a *NotFoundError when no Scholarship entities are found.
...
// OnlyID is like Only, but returns the only Scholarship ID in the query.
// Returns a *NotSingularError when more than one Scholarship ID is found.
...
// Clone returns a duplicate of the ScholarshipQuery builder, including all associated steps. It can be
...
//
//	client.Scholarship.Query().
//		Select(scholarship.FieldName).
//		Scan(ctx, &v)
//
func (sq *ScholarshipQuery) Select(fields ...string) *ScholarshipSelect {
	sq.fields = append(sq.fields, fields...)
	return &ScholarshipSelect{ScholarshipQuery: sq}
}
...
func (sq *ScholarshipQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := sq.fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != scholarship.FieldID {
...
func (sq *ScholarshipQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
// ScholarshipGroupBy is the group-by builder for Scholarship entities.
...
// ScholarshipSelect is the builder for selecting fields of Scholarship entities.
...
func (ss *ScholarshipSelect) Scan(ctx context.Context, v interface{}) error {
	...
	ss.sql = ss.ScholarshipQuery.sqlQuery(ctx)
